        ...
        <div className="row">
          <div className="col-lg-3 col-md-6">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <Link to="/text">Terms and conditions</Link>
              </li>
              <li>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul className="list-unstyled">
              <li>
                <Link to="/category">T-shirts</Link>
              </li>
              <li>
                <Link to="/category">Shirts</Link>
              </li>
              <li>
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <Link to="/category">Skirts</Link>
              </li>
              <li>
                <Link to="/category">Pants</Link>
              </li>
              <li>
                <Link to="/category">Accessories</Link>
              </li>
